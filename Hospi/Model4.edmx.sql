...
-- --------------------------------------------------
-- Date Created: 12/28/2014 00:29:59
-- Generated from EDMX file: C:\Users\Soroush\documents\visual studio 2012\Projects\Hospi\Hospi\Model4.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[dbo].[Warrant]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Warrant];
GO
