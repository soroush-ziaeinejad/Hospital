...
-- --------------------------------------------------
-- Date Created: 12/24/2014 07:03:08
-- Generated from EDMX file: C:\Users\Soroush\documents\visual studio 2012\Projects\Hospi\Hospi\Model.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[dbo].[FK_Doctor_Department1]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Doctors] DROP CONSTRAINT [FK_Doctor_Department1];
GO
...
GO
IF OBJECT_ID(N'[HospitalModelStoreContainer].[Logins]', 'U') IS NOT NULL
    DROP TABLE [HospitalModelStoreContainer].[Logins];
GO
...
-- Creating primary key on [Username], [Password], [access] in table 'Logins'
ALTER TABLE [dbo].[Logins]
ADD CONSTRAINT [PK_Logins]
    PRIMARY KEY CLUSTERED ([Username], [Password], [access] ASC);
GO
